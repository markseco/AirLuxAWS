...
export default function PlaneGallery({plane}) {
    ...
    if (showAllPhotos) return (
        <div className="absolute inset-0 bg-white min-h-screen">
            <div className="p-8 grid gap-4">
                <div>
                    <h1 className="text-2xl mr-36">{plane.name}</h1>
                    <button onClick={() => setShowAllPhotos(false)} className="fixed right-12 top-8 flex gap-1 py-2 px-4 bg-white rounded-2xl shadow shadow-md shadow-gray-500">
